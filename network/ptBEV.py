...
#from network.cylinder_fea_generator_lidpix import cylinder_fea
#from network.cylinder_fea_generator_lidseg import cylinder_fea
#from network.cylinder_fea_generator_lidpixseg import cylinder_fea
#from network.cylinder_fea_generator_branched_lidpixseg import cylinder_fea
#from network.cylinder_fea_generator_cross_attention_v2 import cylinder_fea

from network.segmentator_3d_asymm_spconv import Asymm_3d_spconv
#from network.segmentator_3d_asymm_spconv_pixseg_2backbone_noUNet import Asymm_3d_spconv
#from network.segmentator_3d_asymm_spconv_pixseg import Asymm_3d_spconv
#from network.segmentator_3d_asymm_spconv_pixseg_locfix_LVA import Asymm_3d_spconv
#from network.segmentator_3d_asymm_spconv_pixseg_attention_gs import Asymm_3d_spconv
#from network.segmentator_3d_asymm_spconv_cross_attention_v2 import Asymm_3d_spconv
...
class ptBEVnet(nn.Module):
    ...
    def forward(self, train_dict):
        ...
        # 对每个网格的点进行池化
        # breakpoint()
        coords, features_3d, pooled, inv_map = self.cylinder_3d_generator(train_pt_fea_ten, train_vox_ten, train_dict)
        # 主干网络
        sem_prediction, center, offset, instmap, feats = self.cylinder_3d_spconv_seg(features_3d, coords, len(train_pt_fea_ten), pooled)

        center = self.UNet(center)

        return sem_prediction, center, offset, instmap, feats, inv_map, features_3d
